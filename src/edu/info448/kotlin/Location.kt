...
fun listCities(): List<City> = mutableListOf(City("Atlanta", 33.7490, -84.3880),
...
*/
fun distanceFromSeattle(city: City): Double = haversine(city.latitude, city.longitude, 47.6062, -122.3321)
...
fun main(args: Array<String>) {
    ...
    //step 2
    println(distanceFromSeattle(cityLocations.find { it.name == "Tacoma" }!!))
    ...
    //step 7
    val citiesByName = cityLocations.fold(mutableMapOf<String, City>(), { acc, city ->
        acc.put(city.name, city)
        return@fold acc
    })
